<template>
  <div style="display: inline;" v-html="kofi"></div>
</template>

<script>
export default {
  props: {
    pText: { type: String, default: 'Support Me on Ko-fi' },
    pColor: { type: String, default: '#29abe0' },
    pId: { type: String, default: 'I2I42F6OG' }
  },
  computed: {
    kofi() {
      let style = ''
      ...
      init('Support Jelly Party on Ko-fi', '#007bff', 'I2I42F6OG')
      function getHTML() {
        const rtn =
          style +
          html
